...
from api.models import ImagePartRanking, Ranking
...
def process_image_pipeline(
    ...
    for image_parts in images_cropped:
        ...
        ranking = onnx_model.classify_image(image_parts.lower_body)
        log.info("Model results", results=ranking)
        results.append(
            ImagePartRanking(
